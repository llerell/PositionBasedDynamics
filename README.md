...
Use the buttons under the screen to active or desactive random colors for the particles, and reducing the health points of the particles when there is a contact.
...
At first the movements of the particles were instable as the particles kept vibrating, but we solved this problem by repeating several the resolution of the physical system.
