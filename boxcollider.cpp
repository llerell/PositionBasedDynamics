...
BoxCollider::BoxCollider(Vec2 pc_, Vec2 u_, float width_, float height_)
    :Collider(), pc(pc_), u(u_*(1.0/(u_.length()))), width(width_), height(height_), v(Vec2(-u.getY(), u.getX())) {}

BoxCollider::BoxCollider(Vec2 pc_, Vec2 u_, float width_, float height_, bool isKiller_, bool isHealer_)
    :Collider(isKiller_, isHealer_), pc(pc_), u(u_*(1.0/(u_.length()))), width(width_), height(height_), v(Vec2(-u.getY(), u.getX())) {}
